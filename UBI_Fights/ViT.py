...
def create_vit_classifier():
    ...
    for _ in range(transformer_layers):
        ...
        attention_output_1 = tf.keras.layers.MultiHeadAttention(num_heads=num_heads, key_dim=projection_dim,
                                                                dropout=0.1)(x1_1, x1_1)
        # Skip connection 1.
    ...
    for _ in range(transformer_layers):
        ...
        # Create a multi-head attention layer.
        attention_output_2 = tf.keras.layers.MultiHeadAttention(num_heads=num_heads, key_dim=projection_dim,
                                                                dropout=0.1)(x1_2, x1_2)
        # Skip connection 1.
